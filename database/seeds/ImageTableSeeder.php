...
class ImageTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $shop = Shop::where("name","Gloria Jeans Coffee")->firstOrFail();
        Image::create([
        ...
        $shop = Shop::where("name","Lu's Coffee")->firstOrFail();
        Image::create([
        ...
        $shop = Shop::where("name","Story-M Cafe")->firstOrFail();
        Image::create([
        ...
        $shop = Shop::where("name","Thị trấn Ba Cây Chổi")->firstOrFail();
        Image::create([
        ...
        $shop = Shop::where("name","Windmill Saigon Cafe")->firstOrFail();
        Image::create([
